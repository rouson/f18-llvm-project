...
program this_image_tests
  ...
  n = this_image(co_array, home)
  n = this_image(co_array, team=home)
  n = this_image(coarray=co_array, team=home)
  n = this_image(team=home, coarray=co_array)
  ...
  n = this_image(coarray=co_array, team)
